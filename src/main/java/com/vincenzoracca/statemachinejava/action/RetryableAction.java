...
public class RetryableAction<
    ...
    private static final Logger log =
            LoggerFactory.getLogger(RetryableAction.class);

    @Override
    public void execute(S from, S to, E event,
                        PaperContext ctx, T sm) {
        log.info("Transition from '{}' to '{}' on event '{}' – ctx: {}",
                from, to, event, ctx);
    }

    @Override public String  name()    { return "RETRYABLE_ACTION"; }

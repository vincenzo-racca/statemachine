 ...
 */
public class FascicoloChiusoAction<
        T extends StateMachine<T, S, E, PaperContext>,
        S,
        E>
        implements Action<T, S, E, PaperContext> {

    private static final Logger log = LoggerFactory.getLogger(FascicoloChiusoAction.class);
    ...
    @Override public String  name()    { return "FASCICOLO_CHIUSO_ACTION"; }
